 ...
 * 
 */
public abstract class SimulaSAABLogging {
	...
	public static void init() {
		if (SimulaSAABLogging.initialised) {
			return;
		}
		else {
			SimulaSAABLogging.initialised = true;
		}
...
//			Logger logger = Logger.getLogger("repastcity3");
			...
			fileHandler.setLevel(Level.FINE); // Write everything to the file
