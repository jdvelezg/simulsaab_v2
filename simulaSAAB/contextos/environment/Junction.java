...
public class Junction{
	...
	private List<ViaTransitable> roads; // The Roads connected to this Junction, used in GIS road network
	
	public Junction() {
		this.id = UniqueID++;
		this.roads = new ArrayList<ViaTransitable>();
	}
	...
	public List<ViaTransitable> getRoads() {
		return this.roads;
	}
	
	public void addRoad(ViaTransitable road) {
		this.roads.add(road);
	}
